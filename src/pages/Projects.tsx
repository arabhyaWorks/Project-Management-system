              ...
              {filteredProjects.map((project) => (
                <tr key={project.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">
                    ...
                    <div className="text-sm text-gray-500">{project.executingAgency}</div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 text-sm text-gray-500">{project.percentComplete}%</span>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="text-sm text-gray-900">₹{project.amountSanctioned.toLocaleString()} Lacs</div>
                    <div className="text-sm text-gray-500">Released: ₹{project.amountReleased.toLocaleString()} Lacs</div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="text-sm text-gray-900">{format(new Date(project.workStartDate), 'dd MMM yyyy')}</div>
                    <div className="text-sm text-gray-500">to {format(new Date(project.projectCompletionDate), 'dd MMM yyyy')}</div>
                  </td>
                </tr>
              ))}
            </tbody>
